...
const domesticNameservers = [
  ...
  "https://223.6.6.6/dns-query", // 阿里DoH
...
const ruleProviders = {
  ...
  "icloud": {
    ...
    "path": "./ruleset/upstream/icloud.yaml"
  },
  "apple": {
    ...ruleProviderCommon,
    "behavior": "domain",
    "url": "https://fastly.jsdelivr.net/gh/Loyalsoldier/clash-rules@release/apple.txt",
    "path": "./ruleset/upstream/apple.yaml"
  },
  "google": {
    ...ruleProviderCommon,
    "behavior": "domain",
...
function main(config) {
  ...
  config["proxy-groups"] = [
    ...
    },
    {
      ...
      "icon": "https://fastly.jsdelivr.net/gh/lipis/flag-icons@main/flags/4x3/us.svg",
    },
    {
      ...groupBaseOption,
      "name": "日本-自动",
      ...
      "icon": "https://fastly.jsdelivr.net/gh/lipis/flag-icons@main/flags/4x3/jp.svg",
    },
    {
      ...groupBaseOption,
      "name": "韩国-自动",
      ...
      "filter": "(?=.*(广韩|韩国|韓國|KR|首尔|春川|🇰🇷|Korea)).*$",
       "icon": "https://fastly.jsdelivr.net/gh/lipis/flag-icons@main/flags/4x3/kr.svg",
    },
    {
      ...groupBaseOption,
      "name": "英国-自动",
      ...
      "tolerance": 200,
      "include-all": true,
      "filter": "(?=.*(英国|伦敦|GB|🇬🇧|Kingdom)).*$",
      "icon": "https://fastly.jsdelivr.net/gh/lipis/flag-icons@main/flags/4x3/gb.svg",
    },
    {
      ...groupBaseOption,
      "name": "德国-自动",
      ...
      "tolerance": 200,
      "include-all": true,
      "filter": "(?=.*(德国|柏林|DE|🇩🇪|Germany)).*$",
      "icon": "https://fastly.jsdelivr.net/gh/lipis/flag-icons@main/flags/4x3/de.svg",
    },
    {
      ...groupBaseOption,
      "name": "香港-自动",
      ...
      "filter": "(?=.*(广港|香港|HK|Hong Kong|🇭🇰|HongKong)).*$",
       "icon": "https://fastly.jsdelivr.net/gh/lipis/flag-icons@main/flags/4x3/hk.svg",
    },
    {
      ...groupBaseOption,
      "name": "台湾-自动",
    ...
    },
    {
      ...
      "icon": "https://fastly.jsdelivr.net/gh/lipis/flag-icons@main/flags/4x3/sg.svg",
    },
    {
      ...groupBaseOption,
      "name": "漏网之鱼",
